    ...
    <section id="nano_features" className="relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="md:py-20">
          ...
          {/* Grid */}
            <div
                className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:0px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
                <article>
                    ...
                    <p className="text-[15px] text-gray-400">
                        Nano's modular design ensures easy understanding, extension, and maintenance, allowing
                        developers to work efficiently while keeping the codebase flexible and adaptable.
                    </p>
                </article>
                <article>
                    <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                        ...
                        <span>Concurrency Management</span>
                    </h3>
                    <p className="text-[15px] text-gray-400">
                        Advanced thread management allows for efficient handling of asynchronous tasks, ensuring high
                ...
                <article>
                    ...
                    <p className="text-[15px] text-gray-400">
                        Simplify inter-component communication with a robust event-driven architecture, enabling
                        decoupled, flexible, and reactive system behavior.
                    </p>
                </article>
                <article>
                    <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                    ...
                    <p className="text-[15px] text-gray-400">
                        Nano is highly efficient, starting in milliseconds and consuming only around 10MB memory, making
                        it perfect for resource-constrained environments.
                    </p>
                </article>
                <article>
                    <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
