...
export default function FeaturesPlanet() {
  return (
    <section id="nano_features" className="relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl text-center md:pb-0">
          ...
          {/* Grid */}
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:0px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Easy Metric</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Is a default Services of Nano which is responsible for collecting metrics.
                This service solves only basic metrics. Currently, there is no mechanism to
                push metrics to other applications.
                <a href="https://github.com/YunaBraska/nano/blob/main/docs/services/metricservice/README.md"
                   target="_blank"
                   rel="noopener noreferrer" className="text-blue-400 italic"> read more</a>
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Simplify Http calls</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Is a default Services of Nano which is responsible for handling basic HTTP
                requests. Each request is processed in its own Thread. Support for Https/SSL
                is coming soon.
                <a href="https://github.com/NanoNative/nano/blob/main/docs/services/httpservice/README.md" target="_blank"
                   rel="noopener noreferrer" className="text-blue-400 italic"> read more</a>
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Ensures reliable logging</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                Lorem Ipsum has been the industry's standard dummy text ever since the Ipsum.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
